% GaussInput2D (modified from COSIVINA toolbox/GaussStimulus2D)
%   Creates a two-dimensional Gaussian stimulus.
%
% Constructor call:
% GaussInput2D(label, size, sigmaY, sigmaX, amplitude, positionY, ...
...
classdef GaussInput2D < Element
  ...
  methods
    % constructor
    function obj = GaussInput2D(label, size, sigmaY, sigmaX, amplitude, positionY, positionX, ...
